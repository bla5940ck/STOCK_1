...
**Arguments**:
```
寫一個 LINE Bot，當使用者傳送『美股』時，抓取昨晚 S&P 500 、那斯達克和費城半導體的漲跌幅，以及可以依據輸入的代碼 例如goog、tsla查詢前晚漲跌幅以及相關最新新聞，當使用者輸入『新聞』，請給我最新美國重要經濟新聞，以及幫我連動如果某些科技股大漲或大跌，可以特別留意台股哪些相關股票，這個可以在輸入完美股代.號後，給予選項，是否查台股與其相關個股，並用都以中文格式化輸出，回覆需條列式顯示。
```
